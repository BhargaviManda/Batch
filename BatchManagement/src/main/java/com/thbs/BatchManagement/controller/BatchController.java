...
public class BatchController {
    ...
    public List<Integer> getMergedEmployeeIds() {
        List<Integer> mergedEmployeeIds = new ArrayList<>();
        // Fetch data from the first path
        String firstPathUrl = "http://172.18.4.185:7001/user/getId";
    ...
    @GetMapping("/remaining-employees/{batchName}")
	public List<Integer> findRemainingEmployees(@PathVariable String batchName) {
	    List<Integer> allEmployeeIds = getMergedEmployeeIds(); // Fetch all employee IDs, you can implement this logic
